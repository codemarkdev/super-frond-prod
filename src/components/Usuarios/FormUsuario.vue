<template>
	<form>
		<b-field label="Nombre de usuario" >
            <b-input  icon="shield-account" type="text" placeholder="Ej. Juan" v-model="datosUsuario.usuario"></b-input>
        </b-field>
        <b-field label="Nombre completo " >
            <b-input  icon="account" type="text" placeholder="Ej. Juan Perez" v-model="datosUsuario.nombre"></b-input>
        </b-field>
        <b-field label="Teléfono del usuario" >
            <b-input step="any" icon="phone" type="number" placeholder="Ej. 737737737" v-model="datosUsuario.telefono"></b-input>
        </b-field>
